...
using PlanningBudget.Windows.Views;
using System;
...
namespace PlanningBudget.Windows
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            await DataAccess.DataAccessProvider.SetupDB();
        ...
        {
            navigationService.Configure("AddIncomeView", typeof(AddIncomeView));
            navigationService.Configure("AddExpenseView", typeof(AddExpenseView));
            navigationService.Configure("AddAccountView", typeof(AddAccountView));
            navigationService.Configure("ProfilesView", typeof(ProfilesView));
            navigationService.Configure("TransactionListView", typeof(TransactionListView));
            navigationService.Configure("EditCategoryView", typeof(EditCategoryView));
            navigationService.Configure("AddCategoryView", typeof(AddCategoryView));
